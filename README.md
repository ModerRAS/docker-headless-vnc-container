...
## Build Status
`master`:  [![Build Status](https://travis-ci.org/ModerRAS/docker-headless-vnc-container.svg?branch=master)](https://travis-ci.org/ModerRAS/docker-headless-vnc-container)
